...
using Lykke.Job.PayTelegramReporter.Settings;
using Lykke.Job.PayTelegramReporter.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.PayTelegramReporter
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "PayTelegramReporterJob API";
